...
exec_directory = /Users/yihao/Desktop/arkzero/神经网络/dist
project_file = 
...
macos.permissions = 
mode = standalone
extra_args = --noinclude-qt-translations --include-package=desktop --include-package=arknights_sim --include-package=agents --include-package=network --include-package=mcts --include-package=training --include-data-dir=data/real=data/real --include-data-files=configs/desktop_default.yaml=configs/desktop_default.yaml --include-data-files=configs/alphazero_001.yaml=configs/alphazero_001.yaml --include-data-dir=desktop/resources=desktop/resources --include-data-files=checkpoints/best.pt=bundled_checkpoints/best.pt --jobs=4 --macos-app-name="Arknights Zero" --macos-app-version=0.1.0
